                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item mt-2">
                            <a href="{{ route('notifications.index') }}">
                                ...
                                @if(auth()->user()->unreadNotifications()->count() > 0)
                                    <span class="badge badge-pill badge-primary">{{ auth()->user()->getUnreadNotificationsCount() }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="menu-item mt-2">
                            <a href="{{ route('messages.index') }}">
                                ...
                                @if(auth()->user()->getUnreadMessagesCount() > 0)
                                    <span class="badge badge-pill badge-primary">{{ auth()->user()->getUnreadMessagesCount() }}</span>
                                @endif
                            </a>
                        ...
                        <li class="menu-item mt-2">
                            ...
                            document.getElementById('logout-form').submit();">
                                <svg style="width: 28px; margin-right: 16px;" viewBox="0 0 20 20" fill="currentColor" class="logout w-6 h-6"><path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd"></path></svg>Logout
                            </a>
                        </li>
                        <li class="mt-2"><a href="{{ route('tweets.index') }}" class="button text-center mt-4">Tweet</a></li>
                    </ul>
                </nav>    
            </div>
